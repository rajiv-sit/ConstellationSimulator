                    ...
                    for (var entry : states.entrySet()) {
                        ...
                        if (selectedSatelliteName[0] != null && selectedSatelliteName[0].equals(name)) {
                            infoDisplay.setText(String.format(
                                    "%s\nPos: [%.1f km, %.1f km, %.1f km]\nVel: [%.2f km/s, %.2f km/s, %.2f km/s]",
                            ...
                            System.out.printf(
                            "%-12s | Pos: [%.1f km, %.1f km, %.1f km] | Vel: [%.3f km/s, %.3f km/s, %.3f km/s] | Range: %.1f km | Speed: %.3f km/s%n",
                            name, pos.x, pos.y, pos.z, vel.x, vel.y, vel.z, range, speed);
